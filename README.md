...
React Component wrapper for the HTML audio tag. Out of the box, provides a featured, clean-looking audio player. Offers a powerful API for building a rich, totally customized audio player UI.
